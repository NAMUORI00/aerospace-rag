...
- Knowledge extraction uses Ollama by default. Colab sets `EXTRACTOR_FALLBACK_ON_ERROR=true`, `OLLAMA_EXTRACT_TIMEOUT_SECONDS=300`, `OLLAMA_EXTRACT_RETRIES=1`, and generation limits so indexing can continue if one Ollama extraction call times out.
