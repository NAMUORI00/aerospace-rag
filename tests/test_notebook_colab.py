...
class NotebookColabTests(unittest.TestCase):
    def test_notebook_uses_runtime_helper_and_keeps_user_flow(self) -> None:
        ...
        self.assertIn("EXTRACTOR_FALLBACK_ON_ERROR = True", code_source)
        self.assertIn("OLLAMA_EXTRACT_TIMEOUT_SECONDS = 300", code_source)
        self.assertIn("OLLAMA_GENERATE_TIMEOUT_SECONDS = 300", code_source)
