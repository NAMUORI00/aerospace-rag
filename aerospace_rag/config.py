...
class Settings:
    ...
    knowledge_extract_max_chars: int = 700
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            knowledge_extract_max_chars=_env_int("KNOWLEDGE_EXTRACT_MAX_CHARS", 700),
            ...
            vllm_gpu_memory_utilization=_env_float("AEROSPACE_VLLM_GPU_MEMORY_UTILIZATION", 0.70),
            vllm_max_model_len=_env_int("AEROSPACE_VLLM_MAX_MODEL_LEN", 1024),
