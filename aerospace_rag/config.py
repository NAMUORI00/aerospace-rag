...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            llm_model=os.environ.get("VLLM_MODEL", os.environ.get("LLM_MODEL", "google/gemma-4-E4B-it")),
            vllm_dtype=os.environ.get("VLLM_DTYPE", "auto"),
            vllm_gpu_memory_utilization=_env_float("VLLM_GPU_MEMORY_UTILIZATION", 0.90),
            vllm_max_model_len=_env_int("VLLM_MAX_MODEL_LEN", 4096),
            vllm_trust_remote_code=_env_bool("VLLM_TRUST_REMOTE_CODE", False),
